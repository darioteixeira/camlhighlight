...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2cd62e5cea8e05006363bee827e13f9d) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "Camlhighlight provides syntax highlighting and pretty-printing facilities for displaying code samples in Ocsigen/Eliom applications. The library works by interfacing with the library portion of GNU Source-highlight, a popular application supporting the most common programming and markup languages."
              ];
          categories = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "\016\2286m\248\248\202\180\150H\144 \152\029\200A";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
