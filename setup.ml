...
(* OASIS_START *)
(* DO NOT EDIT (digest: 274872060c304bc3ef830ccf6d57103a) *)
(*
...
let setup_t =
  {
     ...
     doc = [("camlhighlight", OCamlbuildDocPlugin.doc_build "src")];
     ...
     clean_doc = [("camlhighlight", OCamlbuildDocPlugin.doc_clean "src")];
     distclean = [];
     distclean_test =
       [
          ("test_parser",
     ...
     package =
       {
          ...
          sections =
            [
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_c_sources = ["source-highlight_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt =
                        [
                           (OASISExpr.EBool true,
                             ["-x"; "c++"; "-Wall"; "-W"; "-Wextra"; "-O2"])
                        ];
                      bs_cclib =
                        [(OASISExpr.EBool true, ["-lsource-highlight"])];
                      ...
                      },
                   {
                      ...
                      lib_findlib_name = Some "camlhighlight";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     cs_name = "camlhighlight_core";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      lib_modules = ["Camlhighlight_core"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "camlhighlight";
                      lib_findlib_name = Some "core";
                      lib_findlib_containers = [];
                      });
               Library
                 ({
                     cs_name = "camlhighlight_parser";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("extlib", None);
                           FindlibPackage ("sexplib", None);
                           InternalLibrary "camlhighlight_core"
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["source-highlight_stubs.c"];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Camlhighlight_parser"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "camlhighlight";
               ...
               Library
                 ({
                     cs_name = "camlhighlight_write_html5";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                   ...
                   {
                      lib_modules = ["Camlhighlight_write_html5"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "camlhighlight";
                      lib_findlib_name = Some "write_html5";
                      lib_findlib_containers = [];
                      });
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for Camlhighlight";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "tests";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "camlhighlight"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\159\029%\012\228\rOMe\130\t\240,\211Ng";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
