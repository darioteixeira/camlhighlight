...
(* OASIS_START *)
(* DO NOT EDIT (digest: 79a9d1a514b97f4a5716d18a3b10d15c) *)
(*
...
let setup_t =
  {
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("tyxml",
                               Some (OASISVersion.VGreaterEqual "3.6"))
                        ];
                      bs_build_tools =
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\158E\227\197\2378>\160\022\\\003\234\237d\213\161";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
