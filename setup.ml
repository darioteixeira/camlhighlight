...
(* OASIS_START *)
(* DO NOT EDIT (digest: af42b88f11059906b062d6738a1e34dc) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "http://camlhighlight.forge.ocamlcore.org/";
          synopsis = "Syntax highlighting for Ocsigen applications";
          description =
            Some
              [
                 OASISText.Para
                   "Camlhighlight provides syntax highlighting and pretty-printing facilities for displaying code samples in Ocsigen applications. The library works by interfacing with the library portion of GNU Source-highlight, a popular application supporting the most common programming and markup languages."
              ];
          categories = [];
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("tyxml", Some (OASISVersion.VGreaterEqual "4"))
                        ];
                      bs_build_tools =
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some ")\158\164\155I\252\170P,\178\171\198\031\024\229\\";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
